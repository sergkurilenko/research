...
print("ATTACK_BEGIN bdd_hybrid", flush=True)
started = time.monotonic()
try:
    result = LWE.primal_hybrid(params, mitm=False, babai=False, red_cost_model=RC.MATZOV, red_shape_model=Simulator.GSA)
    print("ATTACK bdd_hybrid ::", result, flush=True)
