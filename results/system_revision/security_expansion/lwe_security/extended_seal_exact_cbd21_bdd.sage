...
print("ATTACK_BEGIN bdd", flush=True)
started = time.monotonic()
try:
    result = LWE.primal_bdd(params, red_cost_model=RC.MATZOV, red_shape_model=Simulator.GSA)
    print("ATTACK bdd ::", result, flush=True)
