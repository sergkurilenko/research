...
print("ATTACK_BEGIN bdd_mitm_hybrid", flush=True)
started = time.monotonic()
try:
    result = LWE.primal_hybrid(params, mitm=True, babai=True, red_cost_model=RC.MATZOV, red_shape_model=Simulator.GSA)
    print("ATTACK bdd_mitm_hybrid ::", result, flush=True)
